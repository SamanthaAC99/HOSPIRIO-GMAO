        ...
        CREAR ACCESORIOS
          ...
          <Grid item xs={12} md={2}>
              ...
              <Grid item xs={12} md={7}>
                  <TextField id="outlined-basic" inputProps={{ style: { textTransform: "uppercase" } }} value={nombre} error={false} fullWidth label="ACCESORIO" variant="outlined" onChange={(event) => { setNombre(event.target.value) }} />
              </Grid>
              {/* <Grid item xs={12} md={2}>
