...
export default function EquiposReubicadosView() {
    ...
    <>
      ...
      <Container>
        ...
        <Table className='table table-ligh table-hover'>
          ...
          <Tbody>
            {elementosin.sort((a, b) => (a.indice - b.indice)).filter((item)=> item.reubicado === true).map((ingresos, index) => (
              <Tr key={index} >
